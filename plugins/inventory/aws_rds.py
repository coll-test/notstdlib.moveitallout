...
- notstdlib.moveitallout.inventory_cache
- notstdlib.moveitallout.constructed
- notstdlib.moveitallout.aws_credentials
'''
...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.aws.core import is_boto3_error_code
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.ec2 import ansible_dict_to_boto3_filter_list, boto3_tag_list_to_ansible_dict
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.ec2 import camel_dict_to_snake_dict
...
class InventoryModule(BaseInventoryPlugin, Constructable, Cacheable):
    ...
    NAME = 'notstdlib.moveitallout.aws_rds'
