...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.vultr import Vultr, VULTR_API_ENDPOINT, VULTR_USER_AGENT
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    NAME = 'notstdlib.moveitallout.vultr'
