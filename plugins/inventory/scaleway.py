...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.scaleway import SCALEWAY_LOCATION, parse_pagination_link
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    NAME = 'notstdlib.moveitallout.scaleway'
