...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.docker.common import update_tls_hostname, get_connect_params
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    NAME = 'notstdlib.moveitallout.docker_swarm'
