...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.urls import Request, urllib_error, ConnectionError, socket, httplib
...
class InventoryModule(BaseInventoryPlugin):
    NAME = 'notstdlib.moveitallout.tower'
