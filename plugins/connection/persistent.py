...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.connection import Connection as SocketConnection
...
class Connection(ConnectionBase):
    ...
    transport = 'notstdlib.moveitallout.persistent'
