...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils._text import to_bytes, to_native, to_text
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.basic import missing_required_lib
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.parsing.convert_bool import BOOLEANS_TRUE, BOOLEANS_FALSE
...
class Connection(NetworkConnectionBase):
    ...
    transport = 'notstdlib.moveitallout.netconf'
