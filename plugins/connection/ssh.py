...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.parsing.convert_bool import BOOLEANS, boolean
from ansible.plugins.connection import ConnectionBase, BUFSIZE
from ansible_collections.notstdlib.moveitallout.plugins.shell.powershell import _parse_clixml
...
class Connection(ConnectionBase):
    ...
    transport = 'notstdlib.moveitallout.ssh'
    has_pipelining = True
