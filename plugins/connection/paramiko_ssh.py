...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.compat.paramiko import PARAMIKO_IMPORT_ERR, paramiko
...
class Connection(ConnectionBase):
    ...
    transport = 'notstdlib.moveitallout.paramiko'
    _log_channel = None
