...
- notstdlib.moveitallout.oracle
- notstdlib.moveitallout.oracle_creatable_resource
- notstdlib.moveitallout.oracle_wait_options
- notstdlib.moveitallout.oracle_tags
'''
...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.oracle import oci_utils
