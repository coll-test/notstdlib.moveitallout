...
- notstdlib.moveitallout.kubevirt_vm_options
- notstdlib.moveitallout.kubevirt_common_options
'''
...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.kubevirt import (
    virtdict,
    KubeVirtRawModule,
    VM_COMMON_ARG_SPEC,
