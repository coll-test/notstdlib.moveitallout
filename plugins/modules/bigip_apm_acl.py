...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.module_utils.compat.ipaddress import ip_network
    from ansible_collections.notstdlib.moveitallout.plugins.module_utils.compat.ipaddress import ip_interface
