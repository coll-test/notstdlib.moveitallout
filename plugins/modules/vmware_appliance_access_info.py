...
- notstdlib.moveitallout.VmwareRestModule.documentation
'''
...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.vmware_httpapi.VmwareRestModule import API, VmwareRestModule
