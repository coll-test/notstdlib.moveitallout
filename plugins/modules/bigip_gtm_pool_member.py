...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.module_utils.compat.ipaddress import ip_address
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.f5.icontrol import module_provisioned
