...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.urls import urlparse
...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.common.utils import remove_default_spec
...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.f5.common import is_valid_hostname
    from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.f5.common import flatten_boolean
    from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.f5.compare import cmp_str_with_none
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.f5.icontrol import TransactionContextManager
