...
- notstdlib.moveitallout.openstack
'''
...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.openstack import openstack_full_argument_spec, openstack_module_kwargs, openstack_cloud_from_module
