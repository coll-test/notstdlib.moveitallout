...
- notstdlib.moveitallout.auth_basic
'''
...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.gitlab import findGroup, findProject, gitlabAuthentication
