...
- notstdlib.moveitallout.netapp.eseries
'''
EXAMPLES = """
...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.netapp import NetAppESeriesModule, create_multipart_formdata, request
