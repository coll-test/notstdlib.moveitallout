...
- notstdlib.moveitallout.cloudscale
'''
...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.cloudscale import AnsibleCloudscaleBase, cloudscale_argument_spec
