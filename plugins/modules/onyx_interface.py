...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.onyx.onyx import BaseOnyxModule
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.onyx.onyx import get_interfaces_config
