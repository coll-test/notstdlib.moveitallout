...
- notstdlib.moveitallout.k8s_name_options
- notstdlib.moveitallout.k8s_auth_options
- notstdlib.moveitallout.k8s_resource_options
- notstdlib.moveitallout.k8s_scale_options
'''
...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.k8s.scale import KubernetesAnsibleScaleModule
