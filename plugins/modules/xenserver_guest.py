...
- notstdlib.moveitallout.xenserver.documentation
'''
...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.xenserver import (xenserver_common_argument_spec, XAPI, XenServerObject, get_object_ref,
