...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.ios.ios import run_commands, get_capabilities
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.ios.ios import normalize_interface
