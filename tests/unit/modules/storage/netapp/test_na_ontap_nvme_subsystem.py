...
from ansible_collections.notstdlib.moveitallout.plugins.modules.na_ontap_nvme_subsystem \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.modules.na_ontap_nvme_subsystem.NetAppONTAPNVMESubsystem.create_subsystem')
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.modules.na_ontap_nvme_subsystem.NetAppONTAPNVMESubsystem.delete_subsystem')
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.modules.na_ontap_nvme_subsystem.NetAppONTAPNVMESubsystem.add_subsystem_host_map')
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.modules.na_ontap_nvme_subsystem.NetAppONTAPNVMESubsystem.remove_subsystem_host_map')
