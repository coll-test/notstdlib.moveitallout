...
from ansible_collections.notstdlib.moveitallout.plugins.modules.na_ontap_quotas \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.modules.na_ontap_quotas.NetAppONTAPQuotas.quota_entry_set')
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.modules.na_ontap_quotas.NetAppONTAPQuotas.quota_entry_delete')
