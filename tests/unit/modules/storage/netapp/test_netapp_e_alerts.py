...
from ansible_collections.notstdlib.moveitallout.plugins.modules.netapp_e_alerts import Alerts
...
class AlertsTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.notstdlib.moveitallout.plugins.modules.netapp_e_alerts.request'
