...
from ansible_collections.notstdlib.moveitallout.plugins.modules.netapp_e_iscsi_interface import IscsiInterface
...
class IscsiInterfaceTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.notstdlib.moveitallout.plugins.modules.netapp_e_iscsi_interface.request'
