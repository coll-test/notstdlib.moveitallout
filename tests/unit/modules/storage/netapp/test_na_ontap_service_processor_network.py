...
from ansible_collections.notstdlib.moveitallout.plugins.modules.na_ontap_service_processor_network \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.modules.na_ontap_service_processor_network.NetAppOntapServiceProcessorNetwork.'
