...
from ansible_collections.notstdlib.moveitallout.plugins.modules.netapp_e_syslog import Syslog
...
class AsupTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.notstdlib.moveitallout.plugins.modules.netapp_e_syslog.request'
