...
from ansible_collections.notstdlib.moveitallout.plugins.modules.netapp_e_auditlog import AuditLog
...
class AuditLogTests(ModuleTestCase):
    REQUIRED_PARAMS = {'api_username': 'rw',
                       ...
                       'ssid': '1'}
    REQ_FUNC = 'ansible_collections.notstdlib.moveitallout.plugins.modules.netapp_e_auditlog.request'
