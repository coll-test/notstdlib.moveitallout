...
from ansible_collections.notstdlib.moveitallout.plugins.modules.netapp_e_iscsi_target import IscsiTarget
...
class IscsiTargetTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.notstdlib.moveitallout.plugins.modules.netapp_e_iscsi_target.request'
