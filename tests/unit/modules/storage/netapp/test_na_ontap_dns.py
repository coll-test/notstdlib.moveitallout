...
from ansible_collections.notstdlib.moveitallout.plugins.modules.na_ontap_dns \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.netapp.OntapRestAPI.send_request')
