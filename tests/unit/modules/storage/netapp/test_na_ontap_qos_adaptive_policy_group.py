...
from ansible_collections.notstdlib.moveitallout.plugins.modules.na_ontap_qos_adaptive_policy_group \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.modules.na_ontap_qos_adaptive_policy_group.NetAppOntapAdaptiveQosPolicyGroup.get_policy_group')
