...
from ansible_collections.notstdlib.moveitallout.plugins.modules.netapp_e_facts import Facts
...
class FactsTest(ModuleTestCase):
    ...
    REQUEST_FUNC = 'ansible_collections.notstdlib.moveitallout.plugins.modules.netapp_e_facts.Facts.request'
    GET_CONTROLLERS_FUNC = 'ansible_collections.notstdlib.moveitallout.plugins.modules.netapp_e_facts.Facts.get_controllers'
