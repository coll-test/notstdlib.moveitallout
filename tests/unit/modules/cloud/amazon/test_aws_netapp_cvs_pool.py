...
from ansible_collections.notstdlib.moveitallout.plugins.modules.aws_netapp_cvs_pool \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.modules.aws_netapp_cvs_pool.NetAppAWSCVS.get_aws_netapp_cvs_pool')
    @patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.netapp.AwsCvsRestAPI.put')
