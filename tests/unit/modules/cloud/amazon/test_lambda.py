...
from ansible_collections.notstdlib.moveitallout.tests.unit.compat.mock import MagicMock, Mock, patch
...
_temp = __import__('ansible_collections.notstdlib.moveitallout.plugins.modules.lambda')
