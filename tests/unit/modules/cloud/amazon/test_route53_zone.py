...
from ansible_collections.notstdlib.moveitallout.plugins.modules import route53_zone
...
@patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.aws.core.HAS_BOTO3', new=True)
