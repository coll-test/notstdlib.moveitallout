...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.kubevirt import KubeVirtRawModule
from ansible_collections.notstdlib.moveitallout.plugins.modules import kubevirt_vm as mymodule
