...
def XenAPI():
    ...
    fake_xenapi = importlib.import_module('ansible_collections.notstdlib.moveitallout.tests.unit.modules.cloud.xenserver.FakeXenAPI')
...
def xenserver_guest_info(XenAPI):
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules import xenserver_guest_info
...
def xenserver_guest_powerstate(XenAPI):
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules import xenserver_guest_powerstate
