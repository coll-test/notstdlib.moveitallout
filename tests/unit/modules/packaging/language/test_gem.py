...
from ansible_collections.notstdlib.moveitallout.plugins.modules import gem
...
class TestGem(ModuleTestCase):
    def setUp(self):
        ...
        self.mocker.patch(
            'ansible_collections.notstdlib.moveitallout.plugins.modules.gem.get_rubygems_path',
    ...
    def patch_installed_versions(self, versions):
        ...
        target = 'ansible_collections.notstdlib.moveitallout.plugins.modules.gem.get_installed_versions'
    ...
    def patch_rubygems_version(self, version=None):
        target = 'ansible_collections.notstdlib.moveitallout.plugins.modules.gem.get_rubygems_version'
    ...
    def patch_run_command(self):
        target = 'ansible_collections.notstdlib.moveitallout.plugins.module_utils.basic.AnsibleModule.run_command'
