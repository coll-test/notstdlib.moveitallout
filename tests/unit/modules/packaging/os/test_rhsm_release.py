...
from ansible_collections.notstdlib.moveitallout.plugins.modules import rhsm_release
from ansible_collections.notstdlib.moveitallout.tests.unit.modules.utils import (
...
class RhsmRepositoryReleaseModuleTestCase(ModuleTestCase):
    ...
    def setUp(self):
        ...
        self.mock_run_command = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.rhsm_release.'
        ...
        self.mock_get_bin_path = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.rhsm_release.'
