...
from ansible_collections.notstdlib.moveitallout.plugins.modules import apk
...
class TestApkQueryLatest(unittest.TestCase):
    ...
    @mock.patch('ansible_collections.notstdlib.moveitallout.plugins.modules.apk.AnsibleModule')
