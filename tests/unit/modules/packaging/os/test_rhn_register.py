...
from ansible_collections.notstdlib.moveitallout.plugins.modules import rhn_register
...
def test_systemid_with_requirements(capfd, mocker, patch_rhn):
    ...
    mocker.patch('ansible_collections.notstdlib.moveitallout.plugins.modules.rhn_register.open', mock_open(read_data=SYSTEMID), create=True)
