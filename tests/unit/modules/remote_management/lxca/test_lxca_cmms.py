...
from ansible_collections.notstdlib.moveitallout.plugins.modules import lxca_cmms
...
class TestMyModule():
    ...
    @mock.patch('ansible_collections.notstdlib.moveitallout.plugins.modules.lxca_cmms.execute_module', autospec=True)
    ...
    @mock.patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.remote_management.lxca.common.setup_conn', autospec=True)
    @mock.patch('ansible_collections.notstdlib.moveitallout.plugins.modules.lxca_cmms.execute_module', autospec=True)
    @mock.patch('ansible_collections.notstdlib.moveitallout.plugins.modules.lxca_cmms.AnsibleModule', autospec=True)
    ...
    @mock.patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.remote_management.lxca.common.setup_conn', autospec=True)
    @mock.patch('ansible_collections.notstdlib.moveitallout.plugins.modules.lxca_cmms._cmms_by_uuid',
                autospec=True)
    @mock.patch('ansible_collections.notstdlib.moveitallout.plugins.modules.lxca_cmms.AnsibleModule',
                autospec=True)
