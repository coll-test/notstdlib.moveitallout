...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cnos_banner
...
class TestCnosBannerModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.cnos_banner.load_config')
