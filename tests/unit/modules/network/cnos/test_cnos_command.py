...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cnos_command
...
class TestCnosCommandModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.cnos_command.run_commands')
