...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cnos_facts
...
class TestCnosFacts(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch(
            'ansible_collections.notstdlib.moveitallout.plugins.modules.cnos_facts.run_commands')
