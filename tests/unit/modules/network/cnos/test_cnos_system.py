...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cnos_system
...
class TestCnosSystemModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.cnos_system.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.cnos_system.load_config')
