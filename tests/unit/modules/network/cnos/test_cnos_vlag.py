...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cnos_vlag
...
class TestCnosVlagModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_cnos_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.cnos.cnos.run_cnos_commands')
