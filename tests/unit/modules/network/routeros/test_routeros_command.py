...
from ansible_collections.notstdlib.moveitallout.plugins.modules import routeros_command
...
class TestRouterosCommandModule(TestRouterosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.routeros_command.run_commands')
