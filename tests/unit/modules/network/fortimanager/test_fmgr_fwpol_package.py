...
try:
    from ansible_collections.notstdlib.moveitallout.plugins.modules import fmgr_fwpol_package
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.notstdlib.moveitallout.plugins.modules.fmgr_fwpol_package.Connection')
    return connection_class_mock
