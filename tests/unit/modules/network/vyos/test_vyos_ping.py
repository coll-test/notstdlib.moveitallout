...
from ansible_collections.notstdlib.moveitallout.plugins.modules import vyos_ping
...
class TestVyosPingModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.vyos_ping.run_commands')
