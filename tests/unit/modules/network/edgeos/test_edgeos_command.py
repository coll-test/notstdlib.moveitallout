...
from ansible_collections.notstdlib.moveitallout.plugins.modules import edgeos_command
...
class TestEdgeosCommandModule(TestEdgeosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.edgeos_command.run_commands')
