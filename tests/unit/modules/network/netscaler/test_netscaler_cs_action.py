...
class TestNetscalerCSActionModule(TestModule):
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.notstdlib.moveitallout.plugins.modules.netscaler_cs_action.get_nitro_client', m):
            with patch('ansible_collections.notstdlib.moveitallout.plugins.modules.netscaler_cs_action.nitro_exception', MockException):
                self.module = netscaler_cs_action
                result = self.failed()
