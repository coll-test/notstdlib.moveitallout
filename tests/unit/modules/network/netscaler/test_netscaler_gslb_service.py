...
class TestNetscalerGSLBSiteModule(TestModule):
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.notstdlib.moveitallout.plugins.modules.netscaler_gslb_service.get_nitro_client', m):
            with patch('ansible_collections.notstdlib.moveitallout.plugins.modules.netscaler_gslb_service.nitro_exception', MockException):
                self.module = netscaler_gslb_service
                result = self.failed()
