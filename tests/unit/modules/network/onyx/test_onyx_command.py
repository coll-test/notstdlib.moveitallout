...
from ansible_collections.notstdlib.moveitallout.plugins.modules import onyx_command
...
class TestOnyxCommandModule(TestOnyxModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch(
            'ansible_collections.notstdlib.moveitallout.plugins.modules.onyx_command.run_commands')
