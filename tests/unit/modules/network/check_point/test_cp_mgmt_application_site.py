...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_application_site
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_application_site.api_call'
