...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_vpn_community_meshed
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_vpn_community_meshed.api_call'
