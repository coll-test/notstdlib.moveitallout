...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_package
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_package.api_call'
