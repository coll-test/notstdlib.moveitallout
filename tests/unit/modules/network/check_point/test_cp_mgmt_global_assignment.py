...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_global_assignment
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_global_assignment.api_call'
