...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_dns_domain
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_dns_domain.api_call'
