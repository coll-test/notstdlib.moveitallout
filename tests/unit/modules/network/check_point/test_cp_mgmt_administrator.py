...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_administrator
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_administrator.api_call'
