...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_access_layer
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_access_layer.api_call'
