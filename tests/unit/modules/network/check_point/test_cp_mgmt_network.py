...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_network
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_network.api_call'
