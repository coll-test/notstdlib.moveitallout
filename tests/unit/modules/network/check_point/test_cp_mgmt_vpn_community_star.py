...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_vpn_community_star
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_vpn_community_star.api_call'
