...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_exception_group
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_exception_group.api_call'
