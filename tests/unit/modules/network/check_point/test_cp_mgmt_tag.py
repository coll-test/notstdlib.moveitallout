...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_tag
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_tag.api_call'
api_call_object = 'tag'
