...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_access_role
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_access_role.api_call'
