...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_service_tcp
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_service_tcp.api_call'
