...
from ansible_collections.notstdlib.moveitallout.plugins.modules import checkpoint_access_rule
...
class TestCheckpointAccessRule(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.notstdlib.moveitallout.plugins.modules.checkpoint_access_rule.Connection')
        return connection_class_mock.return_value

    @pytest.fixture
    def get_access_rule_200(self, mocker):
        mock_function = mocker.patch('ansible_collections.notstdlib.moveitallout.plugins.modules.checkpoint_access_rule.get_access_rule')
