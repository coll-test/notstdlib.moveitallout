...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_application_site_group
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_application_site_group.api_call'
