...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_time
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_time.api_call'
