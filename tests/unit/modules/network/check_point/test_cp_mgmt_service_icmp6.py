...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_service_icmp6
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_service_icmp6.api_call'
