...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_threat_exception
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_threat_exception.api_call'
