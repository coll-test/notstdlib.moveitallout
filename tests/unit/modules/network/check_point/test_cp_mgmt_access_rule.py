...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_access_rule
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_access_rule.api_call'
