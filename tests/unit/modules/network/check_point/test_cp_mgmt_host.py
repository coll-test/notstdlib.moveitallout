...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_host
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_host.api_call'
