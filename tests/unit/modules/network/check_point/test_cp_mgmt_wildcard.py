...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_wildcard
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_wildcard.api_call'
