...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_simple_gateway
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_simple_gateway.api_call'
