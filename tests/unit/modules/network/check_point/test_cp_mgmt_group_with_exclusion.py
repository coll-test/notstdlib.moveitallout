...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_group_with_exclusion
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_group_with_exclusion.api_call'
