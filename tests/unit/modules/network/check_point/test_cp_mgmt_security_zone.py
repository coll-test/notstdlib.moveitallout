...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_security_zone
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_security_zone.api_call'
