...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cp_mgmt_dynamic_object
...
function_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.cp_mgmt_dynamic_object.api_call'
