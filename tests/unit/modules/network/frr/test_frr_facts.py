...
from ansible_collections.notstdlib.moveitallout.plugins.modules import frr_facts
...
class TestFrrFactsModule(TestFrrModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.frr_facts.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_get_capabilities = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.frr_facts.get_capabilities')
