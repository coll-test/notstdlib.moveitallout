...
from ansible_collections.notstdlib.moveitallout.plugins.modules import junos_package
...
class TestJunosPackageModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_device = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.junos_package.get_device')
