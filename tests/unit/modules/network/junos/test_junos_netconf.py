...
from ansible_collections.notstdlib.moveitallout.plugins.modules import junos_netconf
...
class TestJunosCommandModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_capabilities = patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.junos.junos.get_capabilities')
