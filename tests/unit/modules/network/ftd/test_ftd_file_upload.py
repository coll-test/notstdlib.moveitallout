...
from ansible_collections.notstdlib.moveitallout.plugins.modules import ftd_file_upload
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.ftd.fdm_swagger_client import OperationField
...
class TestFtdFileUpload(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.notstdlib.moveitallout.plugins.modules.ftd_file_upload.Connection')
