...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.eos.providers.cli.config.bgp.process import Provider
from ansible_collections.notstdlib.moveitallout.plugins.modules import eos_bgp
