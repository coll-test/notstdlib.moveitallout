...
from ansible_collections.notstdlib.moveitallout.plugins.modules import eos_command
...
class TestEosCommandModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.eos_command.run_commands')
