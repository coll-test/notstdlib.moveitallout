...
from ansible_collections.notstdlib.moveitallout.plugins.modules import aireos_command
...
class TestCiscoWlcCommandModule(TestCiscoWlcModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.aireos_command.run_commands')
