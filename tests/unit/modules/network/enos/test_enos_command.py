...
from ansible_collections.notstdlib.moveitallout.plugins.modules import enos_command
...
class TestEnosCommandModule(TestEnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.enos_command.run_commands')
