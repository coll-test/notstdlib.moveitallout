...
from ansible_collections.notstdlib.moveitallout.plugins.modules import ce_is_is_interface
...
class TestCloudEngineLacpModule(TestCloudEngineModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.ce_is_is_interface.get_nc_config')
        self.get_nc_config = self.mock_get_config.start()

        self.mock_set_config = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.ce_is_is_interface.set_nc_config')
