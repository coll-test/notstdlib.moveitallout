...
from ansible_collections.notstdlib.moveitallout.plugins.modules import iosxr_facts
...
class TestIosxrFacts(TestIosxrModule):
    ...
    def setUp(self):
        ...
        self.mock_get_capabilities = patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.iosxr.facts.legacy.base.get_capabilities')
