...
from ansible_collections.notstdlib.moveitallout.plugins.modules import iosxr_command
...
class TestIosxrCommandModule(TestIosxrModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.iosxr_command.run_commands')
