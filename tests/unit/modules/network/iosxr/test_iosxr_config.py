...
from ansible_collections.notstdlib.moveitallout.plugins.modules import iosxr_config
from ansible_collections.notstdlib.moveitallout.plugins.cliconf.iosxr import Cliconf
...
class TestIosxrConfigModule(TestIosxrModule):
    ...
    def setUp(self):
        ...
        self.patcher_get_config = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.iosxr_config.get_config')
        self.mock_get_config = self.patcher_get_config.start()

        self.patcher_exec_command = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.iosxr_config.load_config')
        self.mock_exec_command = self.patcher_exec_command.start()

        self.mock_get_connection = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.iosxr_config.get_connection')
