...
from ansible_collections.notstdlib.moveitallout.plugins.modules import slxos_facts
...
class TestSlxosFactsModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.slxos_facts.run_commands')
