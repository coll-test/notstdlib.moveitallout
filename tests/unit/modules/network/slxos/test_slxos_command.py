...
from ansible_collections.notstdlib.moveitallout.plugins.modules import slxos_command
...
class TestSlxosCommandModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.slxos_command.run_commands')
