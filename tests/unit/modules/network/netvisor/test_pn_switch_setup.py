...
from ansible_collections.notstdlib.moveitallout.plugins.modules import pn_switch_setup
...
class TestSwitchSetupModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.pn_switch_setup.run_cli')
