...
from ansible_collections.notstdlib.moveitallout.plugins.modules import openvswitch_bridge
...
class TestOpenVSwitchBridgeModule(TestOpenVSwitchModule):
    ...
    def setUp(self):
        ...
        self.mock_run_command = (
            patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.basic.AnsibleModule.run_command'))
