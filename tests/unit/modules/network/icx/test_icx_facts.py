...
from ansible_collections.notstdlib.moveitallout.plugins.modules import icx_facts
...
class TestICXFactsModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.icx_facts.run_commands')
