...
from ansible_collections.notstdlib.moveitallout.plugins.modules import icx_command
...
class TestICXCommandModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.icx_command.run_commands')
