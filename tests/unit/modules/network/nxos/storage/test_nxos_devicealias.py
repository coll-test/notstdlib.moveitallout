...
from ansible_collections.notstdlib.moveitallout.plugins.modules import nxos_devicealias
from ansible_collections.notstdlib.moveitallout.plugins.modules.nxos_devicealias import showDeviceAliasStatus
from ansible_collections.notstdlib.moveitallout.plugins.modules.nxos_devicealias import showDeviceAliasDatabase
...
class TestNxosDeviceAliasModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        module_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.nxos_devicealias.'
