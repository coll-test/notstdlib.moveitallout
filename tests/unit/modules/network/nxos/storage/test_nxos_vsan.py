...
from ansible_collections.notstdlib.moveitallout.plugins.modules import nxos_vsan
from ansible_collections.notstdlib.moveitallout.plugins.modules.nxos_vsan import GetVsanInfoFromSwitch
...
class TestNxosVsanModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        module_path = 'ansible_collections.notstdlib.moveitallout.plugins.modules.nxos_vsan.'
