...
from ansible_collections.notstdlib.moveitallout.plugins.modules import nxos_command
...
class TestNxosCommandModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.nxos_command.run_commands')
