...
from ansible_collections.notstdlib.moveitallout.plugins.modules import cli_config
...
class TestCliConfigModule(TestCliModule):
    ...
    def setUp(self):
        ...
        self.mock_connection = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.cli_config.Connection')
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.modules.cli_config.run')
