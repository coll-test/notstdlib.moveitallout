...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigiq_application_fastl4_udp import ModuleParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigiq_application_fastl4_udp import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigiq_application_fastl4_udp import ArgumentSpec
