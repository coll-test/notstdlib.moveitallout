...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_configsync_action import Parameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_configsync_action import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_configsync_action import ArgumentSpec
