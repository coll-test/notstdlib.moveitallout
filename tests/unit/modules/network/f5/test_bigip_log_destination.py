...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_log_destination import V1ApiParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_log_destination import V1ModuleParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_log_destination import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_log_destination import V1Manager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_log_destination import ArgumentSpec
