...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_asm_dos_application import ApiParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_asm_dos_application import ModuleParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_asm_dos_application import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_asm_dos_application import ArgumentSpec
