...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_smtp import ApiParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_smtp import ModuleParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_smtp import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_smtp import ArgumentSpec
