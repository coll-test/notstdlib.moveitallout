...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_device_certificate import ModuleParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_device_certificate import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_device_certificate import ArgumentSpec
