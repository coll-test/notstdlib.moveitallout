...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_ssl_ocsp import ApiParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_ssl_ocsp import ModuleParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_ssl_ocsp import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_ssl_ocsp import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_ssl_ocsp.tmos_version')
            self.m1 = self.p1.start()
            self.m1.return_value = '13.0.0'
