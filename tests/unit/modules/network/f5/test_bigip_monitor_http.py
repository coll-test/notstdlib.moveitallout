...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_monitor_http import Parameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_monitor_http import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_monitor_http import ArgumentSpec
