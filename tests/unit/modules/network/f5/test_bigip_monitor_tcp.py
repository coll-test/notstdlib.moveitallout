...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_monitor_tcp import Parameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_monitor_tcp import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_monitor_tcp import ArgumentSpec
