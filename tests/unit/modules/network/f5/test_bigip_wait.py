...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_wait import Parameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_wait import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_wait import ArgumentSpec
