...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_appsvcs_extension import ModuleParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_appsvcs_extension import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_appsvcs_extension import ArgumentSpec
