...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_message_routing_peer import ApiParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_message_routing_peer import ModuleParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_message_routing_peer import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_message_routing_peer import GenericModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_message_routing_peer import ArgumentSpec
