...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_monitor_external import ModuleParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_monitor_external import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_monitor_external import ArgumentSpec
