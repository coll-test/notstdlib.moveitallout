...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_selfip import ApiParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_selfip import ModuleParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_selfip import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_selfip import ArgumentSpec
