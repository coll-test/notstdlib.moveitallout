...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_lx_package import Parameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_lx_package import ArgumentSpec
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_lx_package import ModuleManager
