...
try:
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_apm_policy_fetch import ModuleParameters
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_apm_policy_fetch import ModuleManager
    from ansible_collections.notstdlib.moveitallout.plugins.modules.bigip_apm_policy_fetch import ArgumentSpec
