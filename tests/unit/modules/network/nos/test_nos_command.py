...
from ansible_collections.notstdlib.moveitallout.plugins.modules import nos_command
...
class TestNosCommandModule(TestNosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.nos_command.run_commands')
