...
from ansible_collections.notstdlib.moveitallout.plugins.modules import nos_facts
...
class TestNosFactsModule(TestNosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.nos_facts.run_commands')
