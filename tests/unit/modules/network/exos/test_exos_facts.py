...
from ansible_collections.notstdlib.moveitallout.plugins.modules import exos_facts
...
class TestExosFactsModule(TestExosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.exos.facts.legacy.base.run_commands')
