...
from ansible_collections.notstdlib.moveitallout.plugins.modules import exos_command
...
class TestExosCommandModule(TestExosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.exos_command.run_commands')
