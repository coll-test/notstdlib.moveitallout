...
from ansible_collections.notstdlib.moveitallout.plugins.modules import ios_ping
...
class TestIosPingModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.ios_ping.run_commands')
