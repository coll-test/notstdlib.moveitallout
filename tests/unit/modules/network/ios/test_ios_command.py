...
from ansible_collections.notstdlib.moveitallout.plugins.modules import ios_command
...
class TestIosCommandModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.ios_command.run_commands')
