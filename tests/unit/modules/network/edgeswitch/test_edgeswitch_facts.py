...
from ansible_collections.notstdlib.moveitallout.plugins.modules import edgeswitch_facts
...
class TestEdgeswitchFactsModule(TestEdgeswitchModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.edgeswitch_facts.run_commands')
