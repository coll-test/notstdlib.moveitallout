...
from ansible_collections.notstdlib.moveitallout.plugins.modules import voss_facts
...
class TestVossFactsModule(TestVossModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notstdlib.moveitallout.plugins.modules.voss_facts.run_commands')
