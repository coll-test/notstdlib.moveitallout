...
from ansible_collections.notstdlib.moveitallout.plugins.modules import nmcli
...
def mocker_set(mocker, connection_exists=False):
    ...
    """
    mocker.patch('ansible_collections.notstdlib.moveitallout.plugins.modules.nmcli.HAVE_DBUS', True)
    mocker.patch('ansible_collections.notstdlib.moveitallout.plugins.modules.nmcli.HAVE_NM_CLIENT', True)
    get_bin_path = mocker.patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.basic.AnsibleModule.get_bin_path')
