...
from ansible_collections.notstdlib.moveitallout.plugins.lookup.onepassword import OnePass, LookupModule
from ansible_collections.notstdlib.moveitallout.plugins.lookup.onepassword_raw import LookupModule as OnePasswordRawLookup
...
@patch('ansible_collections.notstdlib.moveitallout.plugins.lookup.onepassword.OnePass', MockOnePass)
...
@patch('ansible_collections.notstdlib.moveitallout.plugins.lookup.onepassword_raw.OnePass', MockOnePass)
