...
from ansible_collections.notstdlib.moveitallout.plugins.lookup import password
...
class TestLookupModuleWithoutPasslib(BaseTestLookupModule):
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.lookup.password._write_password_file')
