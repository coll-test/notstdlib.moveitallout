...
from ansible_collections.notstdlib.moveitallout.plugins.connection import ssh
...
class TestSSHConnectionRetries(object):
    ...
    def test_put_file_retries(self, monkeypatch):
        ...
        monkeypatch.setattr('time.sleep', lambda x: None)
        monkeypatch.setattr('ansible_collections.notstdlib.moveitallout.plugins.connection.ssh.os.path.exists', lambda x: True)
