...
if PY3:
    with patch('builtins.__import__', side_effect=import_mock):
        from ansible_collections.notstdlib.moveitallout.plugins.connection import netconf
...
class TestNetconfConnectionClass(unittest.TestCase):
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.connection.netconf.netconf_loader')
