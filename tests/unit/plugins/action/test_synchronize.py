...
from ansible_collections.notstdlib.moveitallout.plugins.action.synchronize import ActionModule
...
class TestSynchronizeAction(unittest.TestCase):
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.action.synchronize.connection_loader', FakePluginLoader)
    def test_basic(self):
        x = SynchronizeTester()
