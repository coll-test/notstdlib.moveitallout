...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.facts import utils
...
class TestGetMountSize(unittest.TestCase):
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.facts.utils.os.statvfs', side_effect=OSError('intentionally induced os error'))
