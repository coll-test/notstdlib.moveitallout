...
def XenAPI():
    ...
    fake_xenapi = importlib.import_module('ansible_collections.notstdlib.moveitallout.tests.unit.module_utils.xenserver.FakeXenAPI')
...
def xenserver(XenAPI):
    ...
    from ansible_collections.notstdlib.moveitallout.plugins.module_utils import xenserver
