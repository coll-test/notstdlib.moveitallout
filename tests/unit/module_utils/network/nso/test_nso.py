...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.nso import nso
...
class TestJsonRpc(unittest.TestCase):
    @patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.nso.nso.open_url')
