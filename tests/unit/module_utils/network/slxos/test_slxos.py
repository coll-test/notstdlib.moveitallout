...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.slxos import slxos
...
class TestPluginCLIConfSLXOS(unittest.TestCase):
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.slxos.slxos.Connection')
