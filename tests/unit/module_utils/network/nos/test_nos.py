...
from ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.nos import nos
...
class TestPluginCLIConfNOS(unittest.TestCase):
    ...
    @patch('ansible_collections.notstdlib.moveitallout.plugins.module_utils.network.nos.nos.Connection')
